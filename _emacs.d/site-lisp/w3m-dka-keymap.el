...
;; need external tool curl installed on system
...
;; from http://www.emacswiki.org/emacs/WThreeMKeymap
(let ((map (make-keymap)))
  (suppress-keymap map)
  ...
  ;; Download function could be selected as you wish
